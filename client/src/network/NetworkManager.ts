...
import { NET, NETWORK_VERSION, validSnapshot, validWelcome, type ClientEvents, type NetworkError, type PlayerCommand, type ServerEvents, type Welcome, type WorldSnapshot } from '@neon-strike/shared/network';

export interface NetworkOptions { address: string; name: string }
...
export class NetworkManager {
  ...
  constructor(options: NetworkOptions, private callbacks: Callbacks) {
    this.socket = io(options.address, {
